...
---başka veritabanını projeye ekleme----
Ekleyeceğimiz veritabanının backup ını alıyoruz.
Alınan backup a server yüklemek için 
Sql tarafında Kullanığımız sqlserver içine girip backup dosyasını yani
.bak uzantılı dosyayı koyuyoruz
...
dbMVCProje.bak dosyasındaki database adını web config 
tarafındaki inital catalog : yazan yere aynı adı yazıyoruz.
web config save et
sonra add-migration edit diye oluştur
update-database olarak güncelle 
Gelsin veriler :)
